...
import pl.edu.uwr.projekt_pum.repository.RestCountriesRepository
...
class RestCountriesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _meal: MutableLiveData<Resource<RestCountriesResponse>> = MutableLiveData()
    ...
    val foodList: LiveData<List<Item>>
        get() = food
    val meal: LiveData<Resource<RestCountriesResponse>>
        get() = _meal
//    init {
